  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.dakashijian" label="打卡时间" prop="dakashijian">
              <el-input v-model="ruleForm.dakashijian" 
                placeholder="打卡时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="打卡状态" prop="dakazhuangtai">
          <el-select v-model="ruleForm.dakazhuangtai" placeholder="请选择打卡状态">
            <el-option
                v-for="(item,index) in dakazhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="打卡状态" prop="dakazhuangtai">
	      <el-input v-model="ruleForm.dakazhuangtai"
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dakashijian = true;
            continue;
	            	            ...
	            	            if(o=='dakazhuangtai'){
            this.ruleForm.dakazhuangtai = obj[o];
	    this.ro.dakazhuangtai = true;
            continue;
          }
	                    }
                                                                                              }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.dakazhuangtaiOptions = "上班,下班".split(',')
                            },
                                                // 多级联动参数
                                                              info(id) {
      this.$http({
