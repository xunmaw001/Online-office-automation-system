          ...
          <el-form-item class="input" label="姓名" prop="xingming">
              <el-input v-model="ruleForm.xingming" 
                placeholder="姓名" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="发薪月份" prop="faxinyuefen">
          <el-select v-model="ruleForm.faxinyuefen" placeholder="请选择发薪月份">
            <el-option
                v-for="(item,index) in faxinyuefenOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="基本工资" prop="jibengongzi">
              <el-input v-model="ruleForm.jibengongzi" 
                placeholder="基本工资" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="奖金提成" prop="jiangjinticheng">
          <el-input v-model="ruleForm.jiangjinticheng" 
              placeholder="奖金提成" clearable  :readonly="ro.jiangjinticheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="奖金提成" prop="jiangjinticheng">
              <el-input v-model="ruleForm.jiangjinticheng" 
                placeholder="奖金提成" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="补贴费用" prop="butiefeiyong">
          <el-input v-model="ruleForm.butiefeiyong" 
              placeholder="补贴费用" clearable  :readonly="ro.butiefeiyong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="补贴费用" prop="butiefeiyong">
              <el-input v-model="ruleForm.butiefeiyong" 
                placeholder="补贴费用" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="考勤扣款" prop="kaoqinkoukuan">
          <el-input v-model="ruleForm.kaoqinkoukuan" 
              placeholder="考勤扣款" clearable  :readonly="ro.kaoqinkoukuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="考勤扣款" prop="kaoqinkoukuan">
              <el-input v-model="ruleForm.kaoqinkoukuan" 
                placeholder="考勤扣款" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                                                shifagongzi: {
                                                                                                                                                                                                                                                                                get: function () {
        return 0+parseFloat(this.ruleForm.jibengongzi==""?0:this.ruleForm.jibengongzi)+parseFloat(this.ruleForm.jiangjinticheng==""?0:this.ruleForm.jiangjinticheng)+parseFloat(this.ruleForm.butiefeiyong==""?0:this.ruleForm.butiefeiyong)-parseFloat(this.ruleForm.kaoqinkoukuan==""?0:this.ruleForm.kaoqinkoukuan)-parseFloat(this.ruleForm.wuxianyijin==""?0:this.ruleForm.wuxianyijin) || 0
      }
    },
                      },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.butiefeiyong = true;
            continue;
	            	            ...
	            	            if(o=='kaoqinkoukuan'){
            this.ruleForm.kaoqinkoukuan = obj[o];
	    this.ro.kaoqinkoukuan = true;
            continue;
          }
	            	            if(o=='wuxianyijin'){
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                          ...
                                                          this.faxinyuefenOptions = "一月,二月,三月,四月,五月,六月,七月,八月,九月,十月,十一月,十二月".split(',')
                                                                                                                                                          },
            // 下二随
    gonghaoChange () {
      this.$http({
