          ...
          <el-form-item class="input" label="会议主题" prop="huiyizhuti">
              <el-input v-model="ruleForm.huiyizhuti" 
                placeholder="会议主题" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议类型" prop="huiyileixing">
          <el-input v-model="ruleForm.huiyileixing" 
              placeholder="会议类型" clearable  :readonly="ro.huiyileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议类型" prop="huiyileixing">
              <el-input v-model="ruleForm.huiyileixing" 
          ...
          <el-form-item class="input" v-if="ruleForm.kaishishijian" label="开始时间" prop="kaishishijian">
              <el-input v-model="ruleForm.kaishishijian" 
                placeholder="开始时间" readonly></el-input>
                                                                                                                                                                                        ...
                                                                                                                                                                                        <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="会议内容" prop="huiyineirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.huiyineirong" label="会议内容" prop="huiyineirong">
                    <span v-html="ruleForm.huiyineirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huiyizhuti = true;
            continue;
	            	            ...
	            	            if(o=='huiyileixing'){
            this.ruleForm.huiyileixing = obj[o];
	    this.ro.huiyileixing = true;
            continue;
          }
	            	            if(o=='kaishishijian'){
	...
	this.ruleForm.huiyineirong = this.ruleForm.huiyineirong.replace(reg,'../../../ssmbqi11/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
